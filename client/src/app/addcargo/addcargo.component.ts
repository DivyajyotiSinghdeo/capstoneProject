...
export class AddcargoComponent{
   itemForm:FormGroup;  
   formModel:any={status:null,paymentStatus:null,shipmentMethod:null};  
   ...
   {      
    this.itemForm = this.formBuilder.group({        
      ...
      estimatedDeliveryDate:[this.formModel.password,[Validators.required,this.dateValidator]],      
      paymentStatus:[this.formModel.password,[Validators.required]],       
      shipmentMethod:[this.formModel.password,[Validators.required]]           
    });  
  }         
